...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("\n>>> Los clientes con sus cuentas y saldos despues de los
        movimientos son: \n");
        mibanco.reporte();
        // Reporte de clientes del banco y el saldo de sus cuentas, despues del cálculo de
        intereses
        mibanco.calcularInteres();
        System.out.println("\n>>> Los clientes con sus cuentas y saldos despues de calcular
        intereses: \n");
        mibanco.reporte();
    }
}
